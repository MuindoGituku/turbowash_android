...
data class PersonalData(
    ...
    @get:PropertyName("date_of_birth") @set:PropertyName("date_of_birth") var dateOfBirth: Timestamp = Timestamp.now(),
)

data class SavedAddress(
    @get:PropertyName("tag") @set:PropertyName("tag") var tag: String = "",
    @get:PropertyName("coordinates") @set:PropertyName("coordinates") var coordinates: PlaceCoordinates = PlaceCoordinates(0.0,0.0),
...
data class MapRegion(
    @get:PropertyName("center") @set:PropertyName("center") var center: PlaceCoordinates = PlaceCoordinates(0.0,0.0),
    @get:PropertyName("radius") @set:PropertyName("radius") var radius: Double = 0.0,
)
